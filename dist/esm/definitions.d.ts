...
export interface SunmiPrinterPlugin {
    ...
    setPrinterStyle(options: {
        key: PrinterStyleKeysEnum;
        value: number | PrinterStyleValuesEnum;
    }): Promise<void>;
    /**
     ...
     * @see setPrinterStyle
     */
    setDoubleWidthPrintStyle(options: {
        enable: boolean;
    }): Promise<void>;
    /**
     ...
     * @see setPrinterStyle
     */
    setDoubleHeightPrintStyle(options: {
        enable: boolean;
    }): Promise<void>;
    /**
     ...
     * @see setPrinterStyle
     */
    setUnderlinePrintStyle(options: {
        enable: boolean;
    }): Promise<void>;
    /**
     ...
     * @see setPrinterStyle
     */
    setAntiWhitePrintStyle(options: {
        enable: boolean;
    }): Promise<void>;
    /**
     ...
     * @see setPrinterStyle
     */
    setStrikethroughPrintStyle(options: {
        enable: boolean;
    }): Promise<void>;
    /**
     ...
     * @see setPrinterStyle
     */
    setTextRightSpacingPrintStyle(options: {
        value: number;
    }): Promise<void>;
    /**
     ...
     * @see setPrinterStyle
     */
    setRelativePositionPrintStyle(options: {
        value: number;
    }): Promise<void>;
    /**
     ...
     * @see setPrinterStyle
     */
    setAbsolutePositionPrintStyle(options: {
        value: number;
    }): Promise<void>;
    /**
     ...
     * @see setPrinterStyle
     */
    setLineSpacingPrintStyle(options: {
        value: number;
    }): Promise<void>;
    /**
     ...
     * @see setPrinterStyle
     */
    setLeftSpacingPrintStyle(options: {
        value: number;
    }): Promise<void>;
    /**
     ...
     * @see setPrinterStyle
     */
    setStrikethroughStylePrintStyle(options: {
        value: number;
    }): Promise<void>;
    /**
     * Get printer mode
     ...
     * @see 1.2.10 Transaction printing
     */
    exitPrinterBufferWithCallback(options?: {
        commit?: boolean;
    }): Promise<void>;
    /**
     ...
     */
    sendLCDAsciiBitmap(options: {
        bitmap: string;
    }): Promise<void>;
    /**
     * Prints barcode on the customer display
     */
    sendLCDBarcode(options: {
        content: string;
        format?: LcdBarcodeFormatEnum;
    }): Promise<void>;
    /**
...
export declare enum PrinterStatusEnum {
...
export declare enum AlignmentModeEnum {
    LEFT = "left",
    CENTER = "center",
    RIGHT = "right"
}
export declare enum PrinterModeEnum {
    GENERAL = "General",
    BLACK_MARK = "BlackMark",
    LABEL = "Label",
    UNKNOWN = "Unknown"
}
export declare enum PrinterStyleKeysEnum {
...
export declare enum PrinterStyleValuesEnum {
    ENABLE = "Enable",
    DISABLE = "Disable"
}
export declare enum LcdCommandEnum {
    INITIALIZATION = "Initialization",
    WAKE_UP = "WakeUp",
    HIBERNATE = "Hibernate",
    CLEAR = "Clear"
}
export declare enum LcdBarcodeFormatEnum {
    UPC_A = "UPC_A",
    UPC_E = "UPC_E",
    EAN_13 = "EAN_13",
    EAN_8 = "EAN_8",
...
export declare enum BarcodeSymbologyEnum {
    UPC_A = "UPC_A",
    UPC_E = "UPC_E",
    EAN_13 = "EAN_13",
    EAN_8 = "EAN_8",
...
export declare enum BarcodeTextPositionEnum {
    NO_TEXT = "NoText",
    ABOVE = "Above",
    BELOW = "Below",
    ABOVE_AND_BELOW = "AboveAndBelow"
}
export declare enum Barcode2DSymbologyEnum {
    QR_CODE = "QR_CODE",
    PDF417 = "PDF417",
    DataMatrix = "DATA_MATRIX"
}
export declare enum BitmapPrintTypeEnum {
    DEFAULT = "Default",
