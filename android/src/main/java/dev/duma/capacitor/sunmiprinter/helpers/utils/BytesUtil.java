...
public class BytesUtil {
    ...
    public static byte[] getZXingQRCode(String qr1, String qr2, int size) {
        try {
            ...
            //图像数据转换，使用了矩阵转换
            BitMatrix bitMatrix1 = new QRCodeWriter().encode(qr1, BarcodeFormat.QR_CODE, size, size, hints);
            BitMatrix bitMatrix2 = new QRCodeWriter().encode(qr2, BarcodeFormat.QR_CODE, size, size, hints);
    ...
    private static byte RGB2Gray(int r, int g, int b) {
        return (false ? ((int) (0.29900 * r + 0.58700 * g + 0.11400 * b) > 200) : ((int) (0.29900 * r + 0.58700 * g + 0.11400 * b) < 200))
            ? (byte) 1
            : (byte) 0;
    }
